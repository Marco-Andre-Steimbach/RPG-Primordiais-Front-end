...
import { fetchMyCharacters } from '../characters.service'
import type { Character } from '../characters.types'

import CharactersFilter from '../components/CharactersFilter'
import '../characters.css'

function CharacterMePage() {
  const [characters, setCharacters] = useState<Character[]>([])
  const [nameFilter, setNameFilter] = useState('')
  const navigate = useNavigate()

  useEffect(() => {
    fetchMyCharacters().then(res => setCharacters(res.characters))
  }, [])
...
export default CharacterMePage
